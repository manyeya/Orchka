...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@orchka/ui/tabs"
...
import { CredentialType, getCredentialTypeLabel } from "@orchka/credentials-core/types"
...
export function HttpSettingsForm({ defaultValues, onSubmit, onCancel }: HttpSettingsFormProps) {
    ...
    const form = useForm<z.input<typeof httpSettingsSchema>, unknown, HttpSettingsFormValues>({
