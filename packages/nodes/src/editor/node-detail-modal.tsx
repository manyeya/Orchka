...
export const NodeDetailModal = memo(({
    ...
    const activeModalId = bridge.activeNodeModalId;
    const isOpen = activeModalId === nodeId;
    const executionData = bridge.nodeExecutionData[nodeId];
    const input = executionData?.input ?? null;
    const output = executionData?.output ?? null;
